...
class Product:
        ...
        while url:
            ...
            if response.status_code == 200:
                ...
                for opinion in opinions:
                    ...
                    single_opinion.extraxt(opinion).translate().transform()
                    self.opinion.append(single_opinion)
    ...
    def generate_charts(self):
        ...
        stars=pd.Serie(self.stats['stars'])
        ax = stars.plot.bar(
...
class Opinion:
    ...
    def __init__(self, opinion_id="", author="", recommend=False, stars=0, content="", pros_pl=[], cons_pl=[], up_votes=0, 
                 down_votes=0, published=None, purchased=None, content_en="", pros_en=[], cons_en=[]):
